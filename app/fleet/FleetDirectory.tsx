...
const fleet: Record<
  Manufacturer,
  Array<{ name: string; operator?: string; image: string }>
> = {
  airbus: [
    { name: "Airbus A220-100 (221)", image: "/images/fleet/a220-100.avif" },
    { name: "Airbus A220-300 (223)", image: "/images/fleet/a220-300.avif" },
    ...
    { name: "Airbus A321neo (21N)", image: "/images/fleet/a321neo.avif" },
    { name: "Airbus A330-200 (332)", image: "/images/fleet/a330-200.avif" },
    { name: "Airbus A330-300 (333)", image: "/images/fleet/a330-300.avif" },
    { name: "Airbus A330-900neo (339)", image: "/images/fleet/a330-900neo.avif" },
      ...
      <div className="fleet-list" role="tabpanel">
        {fleet[selectedManufacturer].map((aircraft) => (
          <article className="fleet-card" key={aircraft.name}>
            <div className="fleet-aircraft-image">
              <Image
                alt=""
                fill
